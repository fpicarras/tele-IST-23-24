...
class bpsk(gr.top_block):
    ...
    def __init__(self, noise, loopB):
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_b([240, 240, 240, 15, 15, 15, 240, 240, 240, ] + [10, 31, 66, 10, 35, 92, 10, 29, 43, ] + [15, 15, 15, 240, 240, 240, 15, 15, 15, 0, 0, 0, 0, 0, 0, 0, 0], False, 1, [])
