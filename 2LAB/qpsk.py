...
class qpsk(gr.top_block):
    ...
    def __init__(self, noise, loopB):
        gr.top_block.__init__(self, "QPSK_mod", catch_exceptions=True)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'qpsk_rec.dat', False)
        self.blocks_file_sink_1.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'qpsk_sent.dat', False)
